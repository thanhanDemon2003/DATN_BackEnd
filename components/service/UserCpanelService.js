  ...
  <body>
    <div class="container">
      ...
      <p>
        ...
        <a href="http://darkdisquite.andemongame.tech/login">Trang Admin</a> và nếu bạn có thắc mắc gì hãy liên hệ với tôi qua mail
...
const sendResetPasswordToEmail = async (email, username, password) => {
  const info = {
    ...
    html: `${username} đã yêu cầu cấp lại mật khẩu
        ...
        Bạn có thể truy cập đường link này để đăng nhập: http://darkdisquite.andemongame.tech/login`
  };
  await transporter.sendMail(info);
}
